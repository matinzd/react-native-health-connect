...
abstract class ReactHealthRecordUtils {
  companion object {
    private fun <T : Record> createReactHealthRecordInstance(recordType: String?): ReactHealthRecord<T> {
      ...
      return reactClass?.newInstance() as ReactHealthRecord<T>
    }

    private fun <T : Record> createReactHealthRecordInstance(recordClass: Class<out Record>): ReactHealthRecord<T> {

...
class ReactHeartRateRecord : ReactHealthRecordImpl<HeartRateRecord> {
  ...
  override fun parseReadResponse(response: ReadRecordsResponse<out HeartRateRecord>): WritableNativeArray {
  ...
  override fun parseReadRequest(options: ReadableMap): ReadRecordsRequest<HeartRateRecord> {
    return convertReactRequestOptionsFromJS(HeartRateRecord::class, options)
  }

...
| [.claude/docs/expo-and-linking.md](.claude/docs/expo-and-linking.md) | Touching `app.plugin.js`, `android-expo/`, `expo-module.config.json`, `example-expo/`, or the CI linking jobs. |
